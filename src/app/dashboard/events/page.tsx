        ...
        <form>
            <div className="space-y-12">
                <div className="border-b border-gray-900/10 pb-12">
                    <h2 className="text-base font-semibold leading-7 text-gray-900">ניהול אירוע</h2>
                    ...
                    <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div className="sm:col-span-4">
                            <h3 className="block text-sm font-medium leading-6 text-gray-900">סוג אירוע</h3>
                            <div className="mt-2 space-y-2">
                                <div className="flex items-center gap-x-3">
                                    ...
                                    />
                                    <label htmlFor="distribution" className="block text-sm font-medium leading-6 text-gray-900">
                                        חלוקה
                                    </label>
                                </div>
                                <div className="flex items-center gap-x-3">
                        ...
                        <div className="sm:col-span-4">
                            <label htmlFor="dateAndTime" className="block text-sm font-medium leading-6 text-gray-900">
                                תאריך ושעה
                            </label>
                            <div className="mt-2">
                                <div className="flex w-80 sm:w-96 rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                    <input
                                        ...
                                        id="dateAndTime"
                                        name="dateAndTime"
                                        value={ new Date(new Date().getTime() + 3 * 60 * 60 * 1000).toISOString().slice(0, 16) }
                                        min={ new Date(new Date().getTime() + 3 * 60 * 60 * 1000).toISOString().slice(0, 16) }
                        ...
                        <div className="sm:col-span-4">
                            <h3 className="block text-sm font-medium leading-6 text-gray-900">סטאטוס אירוע</h3>
                            <div className="mt-2 space-y-2">
                                <div className="flex items-center gap-x-3">
                                    <input
                                        id="ongoing"
                                        ...
                                        className="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600"
                                    />
                                    <label htmlFor="ongoing" className="block text-sm font-medium leading-6 text-gray-900">
                                        מתבצע
                                    </label>
                                </div>
                                <div className="flex items-center gap-x-3">
                                    <input
                                        ...
                                        className="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600"
                                    />
                                    <label htmlFor="frozen" className="block text-sm font-medium leading-6 text-gray-900">
                                        הוקפא
                                    </label>
                                </div>
                                <div className="flex items-center gap-x-3">
                                    <input
                                        ...
                                        className="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600"
                                    />
                                    <label htmlFor="finished" className="block text-sm font-medium leading-6 text-gray-900">
                                        הסתיים
                                    </label>
                                </div>
                            </div>
