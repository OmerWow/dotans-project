...
export default function DonatorsTable({ donatorsString, isReport }: DonatorsTableProps) {
    const donators = JSON.parse(donatorsString) as Donator[];
        ...
        <div className="px-4 sm:px-6 lg:px-8">
            <div className="sm:flex sm:items-center">
                ...
                <div className="mt-4 sm:mt-0 sm:flex-none">
                    {isReport
                        ? <DownloadTableAsCSVButton data={donatorsString} name="תורמים" />
                        : (
                            <Link
...
type DonatorsTableProps = {
    donatorsString: string;
    isReport?: boolean;
};