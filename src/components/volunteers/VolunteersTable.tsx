...
export default function VolunteersTable({ volunteersString, isReport }: VolunteersTableProps) {
    const volunteers = JSON.parse(volunteersString) as Volunteer[];
        ...
        <div className="px-4 sm:px-6 lg:px-8">
            <div className="sm:flex sm:items-center">
                ...
                <div className="mt-4 sm:mt-0 sm:flex-none">
                    {isReport
                        ? <DownloadTableAsCSVButton data={JSON.stringify(volunteers)} name="מתנדבים" />
                        : (
                            <Link
